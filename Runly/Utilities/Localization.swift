...
enum L10n {
    ...
    private static let en: [String: String] = [
        ...
        "schedule.hint": "Once: pick a date & time · Interval: Every 5 minutes · Daily / Weekly: time to the minute · Cron: 0 8 * * 1",
        ...
        "schedule.hint.cron": "5-field cron, e.g. 30 9 * * 1 (minute hour day month weekday)",
        ...
        "settings.launch_at_login.footer": "Independent from per-task launchd schedules.",
    ...
    private static let zhHans: [String: String] = [
        ...
        "schedule.time": "时间",
        "schedule.weekday": "星期",
        "schedule.hint": "一次性：选择日期与时间 · 间隔：Every 5 minutes · 每天/每周：精确到分钟 · Cron：0 8 * * 1",
        ...
        "schedule.hint.cron": "5 段 cron，例如 30 9 * * 1（分 时 日 月 星期）",
        ...
        "settings.launch_at_login.footer": "与各任务的 launchd 日程相互独立。",
        "settings.about": "关于",
        "settings.mode": "模式",
